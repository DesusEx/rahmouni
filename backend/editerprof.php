...
$code=$_GET['code'];
$requete="select * from prof where id_prof='$code'";
		...
		<form action="modifierprof.php" method="post">
			<table id="table">
				<tr>
					...
					<td><input type="text" name="code" class="text" value="<?php echo $ligne['id_prof']?>" readonly="yes" /></td>
				</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="date" value="<?php echo $ligne['tel']?>" ></td>
			</tr>
			<tr>
				<td><label id="lab">MATIERE:</label></td>
				<td><input type="text" name="niv" value="<?php echo $ligne['matiere']?>" ></td>
			</tr>
			<tr>
				<td><label id="lab">SALAIRE:</label></td>
				<td><input type="text" name="grp" value="<?php echo $ligne['salaire']?>" ></td>
